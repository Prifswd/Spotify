...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        ...
        fragment.appendChild(li); // Append the li to the document fragment
    }
    songUL.appendChild(fragment); // Append the fragment to the ul
        ...
        for (let index = 0; index < array.length; index++) {
            ...
            if (e.href.includes("/songs/")) {
                ...
                try {
                    ...
                    console.error("Error fetching album metadata:", error.messag);
                }
            }
        }
